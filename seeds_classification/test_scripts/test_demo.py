...
from seeds_classification.my_utils import single_prediction, test_predictions
from seeds_classification.model_utils import load_model
from seeds_classification.plot_utils import augmentation_demo, training_plots, test_plot
...
modelname = 'resnet50_493classes_30epochs'

# Load training info
info_file = os.path.join(homedir, 'seeds_classification', 'training_info', modelname + '.json')
...
# Load net weights
test_func = load_model(os.path.join(homedir, 'seeds_classification', 'training_weights', modelname + '.npz'), output_dim=output_dim)
