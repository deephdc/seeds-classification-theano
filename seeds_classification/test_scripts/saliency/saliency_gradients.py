...
# Load training info
info_file = op.join(homedir, 'seeds_classification', 'training_info', modelname + '.json')
...
# Load net weights
weights_path = op.join(homedir, 'seeds_classification', 'training_weights', modelname + '.npz')
